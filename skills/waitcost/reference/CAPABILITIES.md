...
| `city_context` | plain profile of a city's homelessness/housing situation | coc | 0 | `city_benchmark` |
...
| `outcome_at_horizon` | how many homeless later | — | 1 | `compartments_over_time` |
...
Non-answerable intents the router also recognises: `greeting`, `out_of_scope`, `clarify` (greeting / clarify / decline — no engine run).
